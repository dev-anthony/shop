...
function Dashboard() {
  ...
  <div className="md:w-1/2 h-full overflow-hidden md:items-start md:text-left py-10 md:py-0">
    ...
    className="bg-white shadow md:mt-4 mt-2 w-auto inline-block cursor-pointer md:text-xl text-xs text-black md:px-6 md:py-3 px-3 py-1.5 rounded-lg font-semibold hover:bg-gray-100 transition">
      View More
    </button>
  </div>
